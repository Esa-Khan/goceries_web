...
class SubCategoryController extends Controller
{
    ...
    public function __construct(SubCategoryRepository $subcategoryRepo, CustomFieldRepository $customFieldRepo, UploadRepository $uploadRepo)
    {
        parent::__construct();
     ...
     *
     * @param SubCategoryDataTable $categoryDataTable
     * @return Response
     */
    public function index(SubCategoryDataTable $categoryDataTable)
    {
